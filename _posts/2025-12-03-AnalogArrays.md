...
For this assignment, we were tasked with programming our arduinos to turn a random PVM pin on and off. The pin would also be set to a random value each time.
